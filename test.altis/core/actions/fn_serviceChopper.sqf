...
if(life_action_gather) exitWith {hint localize "STR_NOTF_Action"};
...
if(!alive (_search select 0) || (_search select 0) distance air_sp > 10) exitWith {life_action_gather = false; hint localize "STR_Service_Chopper_Missing"};
