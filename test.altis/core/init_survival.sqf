[] spawn  {
	...
	_fnc_battery =
	{
		if(life_battery < 2) then {hint "Deine Batterie ist leer.";}
		else
		{
			...
			{
			case 30: {hint "Handyakku liegt bei 30 Prozent.";};
			case 20: {hint "Handyakku liegt bei 20 Prozent.";};
			case 10: {hint "Handyakku liegt bei 10 Prozent.";};
				};
				};
		};
