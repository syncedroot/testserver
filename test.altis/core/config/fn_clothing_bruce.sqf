...
switch (_filter) do
{
	...
	case 0:
	{
		...
		["U_IG_Guerilla1_1",nil,300000],
		["U_I_G_Story_Protagonist_F",nil,300000],
		["U_I_G_resistanceLeader_F",nil,300000],
		["U_O_SpecopsUniform_ocamo",nil,300000],
		["U_O_PilotCoveralls",nil,300000],
		["U_IG_leader","Guerilla Leader",300000]
		];
	};
