...
_query = switch(_side) do {
	...
	case civilian: {_returnCount = 10; format["SELECT playerid, name, cash, bankacc, adminlevel, donatorlvl, civ_licenses, arrested, civ_gear, rebellevel FROM players WHERE playerid='%1'",_uid];};
